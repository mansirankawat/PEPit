...
from PEPit.functions.convex_concave_function import ConvexConcaveFunction
...
def wc_proximal_point(gamma, n, wrapper="cvxpy", solver=None, verbose=1):
    ...
    **References**:
    ...
    func = problem.declare_function(function_class=ConvexConcaveFunction, partition=block_partition)
